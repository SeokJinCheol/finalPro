...
public class RPboardVO {
	...
	public String toString() {
		return "RPboardVO [seqNum=" + seqNum + ", codeNum=" + codeNum + ", bill=" + bill + ", category=" + category
				+ ", title=" + title + ", contents=" + contents + ", adress=" + adress + ", spotNum=" + spotNum
				+ ", packageStatus=" + packageStatus + ", img=" + img + ", reaquestId=" + reaquestId + ", registerId="
				+ registerId + ", company=" + company + ", startDate=" + startDate + ", endDate=" + endDate
