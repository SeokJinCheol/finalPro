	    ...
	    <table style="padding: 70px; text-align:center; border-collapse: collapse; border-spacing: 0; padding-top: 5px; padding-bottom: 10px;">
			<tr class="top-border bottom-border2" style=" height:30px; margin-bottom: 20px; background-color: #80b5ea; color:white; text-align: center;">
	        	...
	        	<td width=60 style="font-family: 'Jeju Gothic', sans-serif; border-right: 1px solid #fff;">사　진</td>
	         	...
	         	<td width=120 style="font-family: 'Jeju Gothic', sans-serif; border-right: 1px solid #fff;">반납기일</td>
	         	<td width=80 style="font-family: 'Jeju Gothic', sans-serif; border-right: 1px solid #fff;">신　 　청</td>
	    	</tr>
			...
			<c:forEach items="${MyRegisterselect}" var="MyRegisterselect">
				<tr onMouseOver="this.style.backgroundColor='#eff7fc'" onMouseOut="this.style.backgroundColor='#fafafa'" style="background-color: #fafafa;">
                	<td style="border-bottom: 3px solid #fff;">${MyRegisterselect.codeNum}</td>
                    <td style="width: 20%; border-bottom: 3px solid #fff;"><img src="/team4/resources/RequestImg/${MyRegisterselect.img}" style="width: 100%; height: 100px;"></td>
                    <td style="border-bottom: 3px solid #fff;">${MyRegisterselect.title}</td>
                    <td style="border-bottom: 3px solid #fff;">${MyRegisterselect.userendDate}</td>
