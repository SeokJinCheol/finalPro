			        	...
			        	<table style="border-collapse: collapse; border-spacing: 0;">
			               ...
			               <tr align="center" height="35"> 
			                  <td colspan="2" class="bottom-border">
			                  	<textarea class="free-insert-content-title" style="resize: none;" name="contents" value="${contents}" rows="10" cols="43" required>${contents}</textarea>
			                  </td>
			               </tr>
						   ...
						   <tr align="center" height="35">
			                  ...
			                  <td class="bottom-border2"><input type="file" name="file" value="${img}" style="margin-left: 10px;"></td>
			               </tr>
						</table>
