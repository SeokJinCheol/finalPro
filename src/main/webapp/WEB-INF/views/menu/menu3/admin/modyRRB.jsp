...
<body>
	<div class="row" style="background:#6699DC; color:white; height:100px; text-align: right;line-height: 130px;">
		...
		<font style="margin-right: 30px;font-family: 'Hanna', fantasy; font-style: bold; font-size: 30px; ">등 록 정 보 수 정</font>
	</div>
	...
	<div align=center style="background: #f5f6f7; width: 1350px; height: 500px; vertical-align: middle; display: table-cell;">
				...
				<div class="option">
					<div>
						<form onsubmit="searchPlaces(); return false;" style="font-family: 'Jeju Gothic', sans-serif; height: 25px;">
							<b>장 소 명　:　</b>
							<input type="text" style="font-family: 'Jeju Gothic', sans-serif; height: 25px;" value="${vo.adress}" id="keyword" size=10 class="free-search-title">
		...
		<div style="margin-bottom: 20px; width: 70%; margin-top:40px;">	
			<form action="RRBADupdate" name="RR" method="post" enctype="multipart/form-data">
				...
				<table style="padding: 20px; width: 70%; text-align:center; border-collapse: collapse; border-spacing: 0; padding-top: 40px; padding-bottom: 20px;">
					<tr align="center" height="38">
				        ...
				        <td width=75 class="top-bottom-border" style="padding-left:7px; padding-right:5px;">
				        	<select name="category" ${vo.category} required style="height:27px; border-radius:4px; text-align:center;">
						...
						<td width=65 class="top-bottom-border" style="">
							<select name="company" value="${vo.company}" required style="height:27px; border-radius:4px; text-align:center;">
						...
						<td class="top-bottom-border">
							<input style="width: 97%;" type="text" name="title" class="free-insert-title" value="${vo.title}" maxlength="30" required>
						</td>
				    </tr>
					...
					<tr height=34>
						<td colspan="3" style="padding-left:2px; padding-top:0px;" class="bottom-border">
							<input type="hidden" name="adress" id="adress" value="${vo.adress}" required>
							<input type="hidden" name="spotNum" id="spotNum" value="${vo.spotNum}" required>
								
		                	<input type="text" id="inpo" class="free-insert-title" style="text-align: center; width:410px;" value="${vo.adress}" readonly>
						</td>
					</tr>
					...
					<tr height=34>
						<td colspan="3" style="padding-left:2px; padding-top:0px;" class="bottom-border">
							&nbsp;<input type="date" class="free-insert-title" style="width:35%; text-align: center" value="${vo.startDate}" onclick="getdate()" name="startDate" required/>
		                  	<!-- ~ 앞뒤로 ㄱ한자 1 숨겨져 있음 -->
		                  	　~　
		                  	<input type="date" class="free-insert-title" onclick="getMin()" value="${vo.endDate}" style="width:35%; text-align: center" min="" name="endDate" required/>
		                </td>
					</tr>              
					...
					<tr height=38>
	               		...
	               		<td colspan="2" class="bottom-border">
	               			<input type="text" name="bill" class="free-insert-title" required style="text-align: center; margin-left: 10px; width:150px;" maxlength="10" value="${vo.bill}"> 원
	               		</td>
	                </tr>              
					...
					<tr height=34>
						<td colspan="3" style="padding-left:2px; padding-top:0px;" class="bottom-border2">			
		                	<textarea class="free-insert-content-title" style="resize: none;" name="contents" cols="48" rows="5" required maxlength="350">${vo.contents}</textarea>
		                </td>
					</tr>                
				</table>
				...
				<p>
					...
					&nbsp;&nbsp;&nbsp;
					<input type="button" class="free_insert-btn w3-card-4" value="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;취　소" onclick="location.href='RRlist'"/>
				</p>
			</form>
		</div>
	</div>
