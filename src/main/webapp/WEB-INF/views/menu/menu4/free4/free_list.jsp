...
<body>	
	<div align=center class="w3-container" style="background: #f5f6f7; width: 1350px; height:500px; vertical-align:middle; display:table-cell;">
		...
		<security:authorize ifAnyGranted="role_user, role_com, role_master">
			<div class="w3-row">
				<div class="w3-col w3-right w3-centered" style="width: 10%; margin-bottom:30px;">
					<input type="button" value ="글쓰기" onclick="location='free_write'">
				</div>
			</div>
		</security:authorize>
		...
		<table border="1" cellspacing="0" >
			<tr  bgcolor="#535353">
				<td  align="center" width="60" height="35" style="color:#ffffff;font-weight:bold;">번호</td>
				<td align="center" width="90"  style="color:#ffffff;font-weight:bold;">이미지</td>				
				<td align="center" style="color:#ffffff;font-weight:bold;">제목</td>				
				<td align="center" width="90" style="color:#ffffff;font-weight:bold;">작성자</td>
				<td align="center" width="70" style="color:#ffffff;font-weight:bold;">조회수</td>
				<td align="center" width="70"  style="color:#ffffff;font-weight:bold;">리플갯수</td>
			</tr>
			...
			<c:forEach items="${list}" var="list">
				<tr height="40" onMouseOver="this.style.backgroundColor='#eff7fc'" onMouseOut="this.style.backgroundColor='#fafafa'"  style="background-color:#fafafa;">				
					...
					<td><a href="free_content?bnum=${list.bnum}">${list.title}</a></td>
					<td>${list.id}</td>
					<td>${list.count}</td>
