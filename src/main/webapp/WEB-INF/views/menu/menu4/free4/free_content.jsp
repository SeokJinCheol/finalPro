		...
		<div style="margin-bottom: 20px; width: 73%; margin-top:40px;">		
			<table  style="border-collapse: collapse; border-spacing: 0;">
  				<tr height="35">
					...
					<td style="text-align: center; font-family: 'Jeju Gothic', sans-serif; border-right:1px solid white;" class="top-bottom-border">제　목</td>
	            ...
	            <tr align=center >
					<td style="margin-right:50px;" rowspan="4" class="bottom-border2" >
						<img src="/team4/resources/BoardImg/${vo.img}" style="width: 300px; height: 300px;">
					</td>
				</tr>
			...
			<div align=center>
				...
				<security:authorize ifAnyGranted="role_master">
						<form action="free_update_get" style="float: left; width: 18%; margin-left: 32%;" method=post>
							<input class="free_update-btn w3-card-4" type="submit" value="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;수　정">
							<input type="hidden" name="bnum" value="${vo.bnum}">
						</form >
						&nbsp;&nbsp;&nbsp;
						<form action="free_delete" method=post style="float: left; width: 18%;">
