	...
	<div align=center class="w3-container"
		...
		<div style="margin-bottom: 20px; width: 73%; margin-top: 40px;">
			<table style="border-collapse: collapse; border-spacing: 0;">
				<tr height="35">
					<td class="top-border"
						style="font-family: 'Jeju Gothic', sans-serif;">&nbsp;&nbsp;물
						품 사 진</td>
					<td
						style="text-align: center; font-family: 'Jeju Gothic', sans-serif; border-right: 1px solid white;"
						class="top-bottom-border">제 목</td>
					<td class="top-bottom-border"><input type="text"
						class="free-insert-title" name="title" style="margin-left: 12px;"
						readonly value="${vo.title }"></td>
				</tr>

				<tr align=center>
					<td style="margin-right: 50px;" rowspan="4" class="bottom-border2">
						<img src="/team4/resources/BoardImg/${vo.img}"
			...
			<div align=center>
				...
				<security:authorize ifAnyGranted="role_master">
					<form action="free_update_get"
						...
						&nbsp;&nbsp;&nbsp;
						<form action="free_delete" method=post
						style="float: left; width: 18%;">
						<input class="free_delete-btn w3-card-4" type="submit"
							value="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;삭　제"
							onclick="setpakageStatus();"> <input type="hidden"
			...
			<security:authorize ifAnyGranted="role_user, role_com, role_master">
				...
				<form action="free4_reply" method="post">
					<table
						...
						<tr>
							<td><textarea class="free-insert-content-title"
									style="resize: none;" name="contents" rows="3" cols="60"
									required></textarea></td>

							<td><input class="reply-btn" type="submit" value="답글">
							</td>
						</tr>
					</table>
					...
					<input type="hidden" name="bnum" value="${vo.bnum}"> <input
						...
						type="hidden" name="img" value="${vo.img}">
				</form>
			</security:authorize>
