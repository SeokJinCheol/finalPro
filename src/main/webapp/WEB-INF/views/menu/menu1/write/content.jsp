			...
			<c:forEach items="${result}" var="result">
				<table style="border-collapse: collapse; border-spacing: 0;">
					...
					<tr height="35">
						...
						<!-- 등록자 -->
						<td width=30 style="text-align:center; font-family: 'Jeju Gothic', sans-serif; border-right: 1px solid white;" class="bottom-border">등 록 자</td>
						
						<td class="bottom-border" width="300" align=center>
							<input type="text" class="free-insert-title" value="${result.reaquestId}" style="text-align: center;" readonly>
						</td>
					</tr>

					<!-- 물품사진 -->
					<tr>
						<td rowspan="7" class="bottom-border2">
							&nbsp;&nbsp;<img src="/team4/resources/RequestImg/${result.img}" style="margin-top:2px; border-radius:5px; width: 90%; height: 290px;" class="w3-card-4">
						</td>
					</tr>

					<!-- 대여가능일자 타이틀 -->
					<tr height="35">
						<td width="300" colspan="2" style="font-family: 'Jeju Gothic', sans-serif; padding-bottom:0px;">대 여 가 능 일 자</td>
					</tr>
					
					<!-- 날짜 표시 -->
					<tr align=center >
						<!-- 대여가능일자 -->
	                  	<td colspan="2" class="bottom-border" width=300 style="padding-bottom:10px;">
