         ...
         <c:forEach items="${RegisterBoardform}" var="RegisterBoardform">
            <form action="RegisterBoardWrite" method="post">
               ...
               <table border="1">
                  ...
                  <tr>
                     <td>대여비</td>
                     <td><input type="number" name="bill" value="${RegisterBoardform.bill}" required maxlength="10">원</td>
                  </tr>
                  
                  <tr>
                     <td>보증금</td>
                     <td><input type="number" name="deposit" value="${RegisterBoardform.deposit}" required maxlength="10">원</td>
                  </tr>
                  <tr>
                     <td>이미지</td>
