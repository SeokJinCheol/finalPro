...
<form action="" method="post">
	<center><div>서비스 이용약관</div></center>
	<center><div><textarea readonly="readonly" cols="100" wrap="virtual" style="resize: none;" onclick="resize(this)">제 1 장 총 칙

 

제 1 조 (목적)
이 약관은 빌리버리(이하 "사이트"라 합니다)에서 제공하는 인터넷서비스(이하 "서비스"라 합니다)의 이용 조건 및 절차에 관한 기본적인 사항을 규정함을 목적으로 합니다.
...
(시행일) 이 약관은 2015년 01월부터 시행합니다. </textarea></div></center>
<center><div><input type="checkbox" name="check" value="1" >위 약관에 동의 하시겠습니까?</div></center>
	<center><div><input type="submit" value="다음" onclick="self.close()"/></div></center>
</form>
</body>
</html>