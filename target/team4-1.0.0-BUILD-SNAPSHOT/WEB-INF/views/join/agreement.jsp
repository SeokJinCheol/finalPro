...
<body style="background-color: #F0F0f0;" align=center>
	<form action="" method="post">
		...
		<div>
			<textarea class=textarea-size readonly cols="90" rows="20" wrap="virtual" style="resize: none;">
제 1 장 총 칙
제 1 조 (목적)
...
(시행일) 이 약관은 2016년 11월부터 시행합니다.</textarea>
		</div>
		
		<div class="w3-row w3-wide" align=center style="margin-bottom:20px;">
			<input type="checkbox" name="check" required onclick="self.close()">&nbsp;귀하는 해당 약관에 동의합니다.
		</div>
	</form>
</body>
</html>